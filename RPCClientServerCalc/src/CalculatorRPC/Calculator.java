...
public class Calculator extends javax.swing.JFrame {
    ...
    public Calculator() throws MalformedURLException {
        initComponents();
        try {
            serverUrl = "http://192.168.43.57:2000/RPC2";
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        try {
            if (value.contains("+")) {
                ...
                vector.addElement(valores[0]);
                vector.addElement("+");
                vector.addElement(valores[1]);
                tfValue.setText(String.valueOf(xmlRpcClient.execute("server.implementsCal", vector)));
                value = "";
                vector.clear();
            }
            if (value.contains("-")) {
